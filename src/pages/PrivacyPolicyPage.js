  ...
  <div>
    <>
      ...
      <p>
        ...
        accessible at HB Hub unless otherwise defined in this Privacy Policy.
      </p>{' '}
      <p>
      ...
      <p>
        We want to inform you that whenever you use our Service, in the case of an error in the app, we collect data and
      ...
      <p>
        The HB Hub app uses location data to track shop locations relative to the user. This allows us to provide a more
        personalized and efficient service by showing relevant shops based on your current location. The location data
        is collected in real-time and is used solely for the purpose of enhancing your experience within the app. We do
        not share this location data with third parties except as described in this Privacy Policy.
      </p>{' '}
      <p>
      ...
      <p>This policy is effective as of 2024-01-18</p>{' '}
      <p>
        <strong>App information</strong>
      </p>{' '}
      <p>
        This privacy policy is valid for this application:
        <a
          href="https://play.google.com/store/apps/details?id=com.remark.osms&hl=en&gl=US"
          target="_blank"
          rel="noopener noreferrer"
        >
          https://play.google.com/store/apps/details?id=com.remark.osms&hl=en&gl=US
        </a>
      </p>{' '}
      <p>
